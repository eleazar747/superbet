...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initWroFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {

        ConfigurableWroFilter filter = new ConfigurableWroFilter();
        filter.setDebug(LoggerFactory.getLogger("ro.isdc.wro").isDebugEnabled());
        FilterRegistration.Dynamic wroFilter = servletContext.addFilter("wroFilter", filter);
     ...
     */
    public void initGzipFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
     ...
     */
    public void initStaticResourcesProductionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
     ...
     */
    public void initCachingHttpHeadersFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
    ...
    private void initMetrics(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        ServletRegistration.Dynamic healthCheckServlet = servletContext.addServlet("healthCheckServlet", new HealthCheckServlet());
